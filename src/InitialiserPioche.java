...
abstract class InitialiserPioche
{
	...
	static ArrayList<Monument> listMonument()
	{
		...
		listMon.add(new Monument("Gare",               4 , "Vous pouvez lancer 2 dés"));
		listMon.add(new Monument("Centre commercial",  10, "Vos batiments de type Agriculture et Magasins vous rapportent 1 pièce supplémentaire"));
		listMon.add(new Monument("Parc d'attractions", 16, "Vous rejouez si vous faites un double"));
		listMon.add(new Monument("Tour radio",         22, "Vous pouvez relancer vos dés une fois par tour."));
